...
class my_vector {
 public:
  my_vector(){};
  virtual std::shared_ptr<my_vector> clone_vec() { return 0; }
  virtual std::shared_ptr<my_vector> clone_space() { return 0; }
  ...
  virtual void scale_add(const double mes, std::shared_ptr<my_vector> vec,
                         const double other) {
  ...
  virtual void take_min(std::shared_ptr<my_vector> vec,
                        std::shared_ptr<my_vector> other = 0) {
    if (vec == 0 || other == 0)
      ;
    assert(0 == 1);
  }
  virtual void take_max(std::shared_ptr<my_vector> vec,
                        std::shared_ptr<my_vector> other = 0) {
    if (vec == 0 || other == 0)
      ;
    assert(0 == 1);
  ...
  virtual void scale_add(const double sc1, std::shared_ptr<my_vector> v1,
                         double sc2, std::shared_ptr<my_vector> v2) {
    scale_add(0., v1, sc1);
    scale_add(1., v2, sc2);
  }
  virtual double my_min() { assert(0 == 1); }
  virtual double my_max() { assert(0 == 1); }
