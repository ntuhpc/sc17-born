...
image_rtm_3d::image_rtm_3d(std::shared_ptr<SEP::genericIO> io, std::string tg,
                           std::shared_ptr<vel_fd_3d> v) {
        ...
        if (i2 + f2 >= 0 && i2 + f2 < a2o.n) {
          for (int i1 = 0; i1 < a1i.n; i1++) {
            if (i1 + f1 >= 0 && i1 + f1 < a1o.n) {
              image->vals[i1 + f1 + (i2 + f2) * a1o.n +
                          (i3 + f3) * a1o.n * a2o.n] +=
                  img->vals[i1 + i2 * a1i.n + i3 * a1i.n * a2i.n];
            }
          }
        }
      }
...
std::shared_ptr<float_3d> image_rtm_3d::extract_sub(SEP::axis a1i,
                                                    SEP::axis a2i,
                                                    SEP::axis a3i) {
  SEP::axis a1o = imgHyper->getAxis(1);
  SEP::axis a2o = imgHyper->getAxis(2);
