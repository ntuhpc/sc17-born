...
class super_vector : public my_vector {
 public:
  super_vector(){};
  super_vector(std::shared_ptr<my_vector> v1, std::shared_ptr<my_vector> v2,
               bool sp = false);
  super_vector(std::shared_ptr<my_vector> v1, std::shared_ptr<my_vector> v2,
               std::shared_ptr<my_vector> v3, bool sp = false);
  ...
  std::shared_ptr<my_vector> clone_vec() { return clone_it(false); }
  std::shared_ptr<my_vector> clone_space() { return clone_it(true); }
