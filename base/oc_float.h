...
class oc_float : public my_vector {
 public:
  ...
  oc_float(std::shared_ptr<SEP::genericIO> io, std::string tag,
           std::vector<SEP::axis> axes, bool alloc = true);
  oc_float(std::shared_ptr<SEP::genericIO> io, std::string tag,
           std::shared_ptr<SEP::hypercube> hyper);
  oc_float(std::shared_ptr<SEP::genericIO> io, std::string tag,
  ...
  void setIO(std::shared_ptr<SEP::genericIO> io) { _io = io; }
  ...
  SEP::axis getAxis(int iax) { return _file->getHyper()->getAxis(iax); }
  std::shared_ptr<SEP::hypercube> getHyper() { return _file->getHyper(); }
